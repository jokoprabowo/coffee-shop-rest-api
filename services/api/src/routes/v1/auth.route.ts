...
import { UserRepository, RefreshTokenRepository, VerificationRepository } from '../../repositories';
...
const authService = new AuthService(userService, verificationRepository, ProducerService);
